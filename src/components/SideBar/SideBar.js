...
class SideBar extends Component {
    ...
    render() {
        const { isActive, updateFilters, filters } = this.props;
        ...
        return(
            <Fragment>
                <ul className={isActive ? `${styles['sidebar-menu']} ${styles.active}` : `${styles['sidebar-menu']}`}>
                    ...
                    {/*</li>*/}
                    <li className={styles['sidebar-menu__item']}>
                        <NavLink exact={true} className={styles['sidebar-menu__link']} activeClassName={styles['is-active']} to="/">
                            <svg width="16" height="19" viewBox="0 0 16 19" xmlns="http://www.w3.org/2000/svg"><path d="M10.576 3.368L15.122.74 14.79 0 9.066 1.897 7.953 4.473H0v1.983h1.148L2.708 18.6h7.875l1.56-12.144h1.147V4.473H10.1"/></svg> Discover
                        </NavLink>
                    </li>
                    <li className={styles['sidebar-menu__item']}>
                        <NavLink exact={true} className={styles['sidebar-menu__link']} activeClassName={styles['is-active']} to="/popular">
                    ...
                    <li className={styles['sidebar-menu__item']}>
                        <NavLink className={styles['sidebar-menu__link']} activeClassName={styles['is-active']} to="/top-rated">
                    ...
                    {currentPath === '/' &&
                        <li className={`${styles['sidebar-menu__item']} ${styles['sidebar-menu__filters']}`}>
                            <Filters
